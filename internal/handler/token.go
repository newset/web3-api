...
// getTokens godoc
// @Summary      查询指定地址拥有的代币
// @Description  查询指定链上某个地址拥有的所有代币余额
// @Tags         tokens
// @Accept       json
// @Produce      json
...
// @Success      200     {object} model.Response{data=model.TokenPage}
// @Failure      400     {object} model.Response
// @Failure      500     {object} model.Response
// @Router       /api/v1/chain/{chain}/tokens [get]
func (h *Handler) getTokens(c *gin.Context) {
	...
	result, err := h.svc.GetTokens(c.Request.Context(), chain, address, cursor)
	if err != nil {
